...
#' See the \href{https://tidyfridoc.statr.me/}{online documentation}
#' for more details.
#'
...
#'                   "skeleton", "skeleton.Rmd", package = "tidyfridoc")
...
################################################################################
    ...
    css_dir  <- system.file("resources", "css",              package = "tidyfridoc")
    hl_dir   <- system.file("resources", "css", "highlight", package = "tidyfridoc")
    font_dir <- system.file("resources", "fonts",            package = "tidyfridoc")
    img_dir  <- system.file("resources", "images",           package = "tidyfridoc")
    js_dir   <- system.file("resources", "js",               package = "tidyfridoc")
    tmpl_dir <- system.file("resources", "templates",        package = "tidyfridoc")
